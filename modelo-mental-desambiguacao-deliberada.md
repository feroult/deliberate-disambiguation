...
Há um paradoxo recorrente no desenvolvimento de software: times ficam melhores nas ferramentas, entregam mais rápido — e o retrabalho não desaparece. Em muitos casos, cresce. Mais PRs. Mais deploys. E, persistentemente, mais conversas sobre "mas não era isso que eu queria dizer".

A explicação intuitiva é que as ferramentas têm limites, que o processo precisa de ajuste. E há verdade nisso. Mas essa explicação não alcança o padrão mais profundo: o retrabalho quase sempre começa antes do código. Começa numa ambiguidade que estava na intenção de quem pediu, não na execução de quem entregou.

O problema não é técnico. É epistêmico. Ele se intensifica exatamente quando a execução fica mais barata — porque ambiguidades que antes levavam semanas para se materializar agora levam horas. A adoção de ferramentas de geração de código tornou esse padrão impossível de ignorar. Mas ele não começou aí.

---

## 2. A tese fundacional: tradução como processo

Para entender esse processo — e o que qualquer mudança no seu custo provoca — é preciso primeiro entender o que o desenvolvimento de software é, não no sentido de práticas e metodologias, mas no sentido do que produz fundamentalmente.
