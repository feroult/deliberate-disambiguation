...
**Slide 14 — O loop**
*Visual:* Imagem gerada. Diagrama circular esquemático, simétrico, sobre fundo escuro.

> **Prompt de imagem:** Minimalist circular schematic diagram on a near-black background (#0d0d14), 16:9 aspect ratio, flat design, no shadows, no 3D effects, no decorative elements. Two nodes are positioned symmetrically — one at the top center of the frame, one at the bottom center — connected by two smooth curved arcs forming a closed oval cycle. The top node is a clean rounded rectangle labeled "D1" in bold white geometric sans-serif, with "Ignorância do domínio" in smaller regular type below it — behind and around this node, a soft diffuse fog halo radiates outward at 40% opacity, blue-grey and undefined, dissolving into the background as if D1 sits at the edge of the unknown; a faint second outer ring of even softer fog surrounds it at greater distance, labeled "2ª ordem — invisível" in very small, low-opacity white type, naming what cannot be clearly seen. The bottom node is a clean rounded rectangle labeled "D2" in bold white, with "Ambiguidade da linguagem" in smaller type — fully sharp, no fog, maximum contrast, crisp border, precise. The right arc flows clockwise from D1 down to D2, a solid white smooth curve with a directional arrowhead at its midpoint pointing toward D2, labeled along the curve in small white type "resolver D1 abre espaço para D2". The left arc flows counter-clockwise from D2 back up to D1, a dashed warm amber curve (#e8a020) with a directional arrowhead at its midpoint pointing toward D1, labeled along the curve in small amber type "tentar D2 revela D1". Both arcs are equal in curvature and length — the composition is perfectly symmetric. The only intentional asymmetry is the fog halo around D1 versus the sharp clarity of D2, and white versus amber on the two arcs. Typography throughout is geometric sans-serif. The composition breathes generously, is centered in the frame, and reads as a complete closed loop at a glance. Aspect ratio 16:9.
